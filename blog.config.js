...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小振', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的打工牛马', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wangz.icu', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '小小振, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '','陕ICP备2025078199' // 备案号 闽ICP备XXXXXX
...
// 鼠标点击烟花特效
  ...
  GREETING_WORDS:
    ...
    'Hi，我是学生、python学习者、一个不喜拘束喜自由的流浪者，欢迎来到我的博客🎉',
